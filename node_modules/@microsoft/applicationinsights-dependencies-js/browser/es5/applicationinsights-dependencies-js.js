...
(function (global, factory) {
    ...
    (function(global){
        var nsKey, key, nm, theExports = {}, modName = "es5_applicationinsights_dependencies_js_3_4_1", msMod="__ms$mod__";
...
function createOTelSpanContext(traceContext) {
    var traceId = isValidTraceId(traceContext[_DYN_TRACE_ID$1 ]) ? traceContext[_DYN_TRACE_ID$1 ] : INVALID_TRACE_ID;
    var spanId = isValidSpanId(traceContext[_DYN_SPAN_ID$1 ]) ? traceContext[_DYN_SPAN_ID$1 ] : INVALID_SPAN_ID;
    var isRemote = traceContext.isRemote;
    var traceFlags = (!isNullOrUndefined(traceContext[_DYN_TRACE_FLAGS$1 ]) ? traceContext[_DYN_TRACE_FLAGS$1 ] : 1 );
            ...
            if (!parentCtx) {
                if (initCtx) {
                    if (isOTelTraceState(initCtx[_DYN_TRACE_STATE$1 ])) {
                        traceState = createW3cTraceState(initCtx[_DYN_TRACE_STATE$1 ].serialize() || STR_EMPTY, parentCtx ? parentCtx[_DYN_TRACE_STATE$1 ] : undefined);
                    }
                    else {
                        traceState = createW3cTraceState(STR_EMPTY, initCtx[_DYN_TRACE_STATE$1 ] || (parentCtx ? parentCtx[_DYN_TRACE_STATE$1 ] : undefined));
                    }
                }
            }
            if (!traceState) {
    ...
    if (url) {
        ...
        if (match != null && match[_DYN_LENGTH$1 ] > 2 && isString(match[2]) && match[2][_DYN_LENGTH$1 ] > 0) {
            ...
            if (inclPort && match[_DYN_LENGTH$1 ] > 2) {
                var protocol = (match[1] || STR_EMPTY)[_DYN_TO_LOWER_CASE$1 ]();
...
function createDistributedTraceContextFromTrace(telemetryTrace, parentCtx) {
    ...
    if (telemetryTrace) {
        ...
        traceCtx[_DYN_TRACE_ID$1 ] = telemetryTrace.traceID || traceCtx[_DYN_TRACE_ID$1 ] || STR_EMPTY;
        traceCtx[_DYN_SPAN_ID$1 ] = telemetryTrace.parentID || traceCtx[_DYN_SPAN_ID$1 ] || STR_EMPTY;
