...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
export var _DYN_REQUEST_URL = "requestUrl"; // Count: 10
export var _DYN_LENGTH = "length"; // Count: 9
export var _DYN_ABORTED = "aborted"; // Count: 5
export var _DYN_TRACE_ID = "traceId"; // Count: 11
export var _DYN_SPAN_ID = "spanId"; // Count: 10
export var _DYN_TRACE_FLAGS = "traceFlags"; // Count: 7
export var _DYN_TRACE_STATE = "traceState"; // Count: 3
export var _DYN_CONTEXT = "context"; // Count: 4
export var _DYN__ADD_HOOK = "_addHook"; // Count: 4
export var _DYN_CORE = "core"; // Count: 7
export var _DYN_INCLUDE_CORRELATION_0 = "includeCorrelationHeaders"; // Count: 4
export var _DYN_GET_ABSOLUTE_URL = "getAbsoluteUrl"; // Count: 4
export var _DYN_HEADERS = "headers"; // Count: 7
export var _DYN_REQUEST_HEADERS = "requestHeaders"; // Count: 15
export var _DYN_SET_REQUEST_HEADER = "setRequestHeader"; // Count: 4
...
export var _DYN_RESPONSE_TEXT = "responseText"; // Count: 7
