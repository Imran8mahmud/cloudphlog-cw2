...
(function (global, factory) {
    var undef = "undefined";
    var nsKey, key, nm, theExports = {}, modName = "es5_applicationinsights_core_js_3_4_1", msMod="__ms$mod__";
...
var DependencyTypes = ( /* @__PURE__ */createEnumStyle({
    InProc: "InProc" ,
...
var UrlRedactionOptions = ( /* @__PURE__ */createEnumStyle({
    true: 1 ,
    false: 2 ,
    appendToDefault: 3 ,
    replaceDefault: 4 ,
...
function isSafari(userAgentStr) {
    if (!userAgentStr || !isString(userAgentStr)) {
        userAgentStr = getUserAgentString()[_DYN_TO_LOWER_CASE ]();
    }
    var ua = (userAgentStr || STR_EMPTY)[_DYN_TO_LOWER_CASE ]();
...
/*#__NO_SIDE_EFFECTS__*/
function handleSpanError(handlers, message, spanName) {
    if (handlers.spanError) {
        handlers.spanError(message, spanName);
    }
}
/*#__NO_SIDE_EFFECTS__*/
function handleDebug(handlers, message) {
    if (handlers.debug) {
...
/*#__NO_SIDE_EFFECTS__*/
function handleWarn(handlers, message) {
    if (handlers[_DYN_WARN ]) {
        handlers[_DYN_WARN ](message);
    }
    else {
        if (console) {
            var fn = console[_DYN_WARN ] || console.log;
            fnApply(fn, console, [message]);
        }
    }
}
/*#__NO_SIDE_EFFECTS__*/
function handleError(handlers, message) {
    if (handlers.error) {
        handlers.error(message);
    }
    else if (handlers[_DYN_WARN ]) {
        handlers[_DYN_WARN ](message);
    }
    else {
        if (console) {
            var fn = console.error || console[_DYN_WARN ] || console.log;
            fnApply(fn, console, [message]);
        }
    }
}
/*#__NO_SIDE_EFFECTS__*/
function handleNotImplemented(handlers, message) {
    if (handlers[_DYN_NOT_IMPLEMENTED ]) {
        handlers[_DYN_NOT_IMPLEMENTED ](message);
    }
    else {
        if (console) {
...
/*#__NO_SIDE_EFFECTS__*/
function createAttributeSnapshot(otelCfg, name, source, attribLimits) {
    var newContainer;
...
/*#__NO_SIDE_EFFECTS__*/
function sanitizeAttributes(otelApi, attributes) {
    var container = createAttributeContainer(otelApi.cfg);
    if (!isObject(attributes) || attributes == null) {
        return {};
    }
    objForEachKey(attributes, function (key, val) {
        if (!isAttributeKey(key)) ;
        else if (!isAttributeValue(val)) ;
        else if (isArray(val)) {
            container.set(key, arrSlice(val));
        }
        else {
            container.set(key, val);
        }
    });
    return container[_DYN_ATTRIBUTES ];
}

var NANOSECOND_DIGITS = 9;
var NANOS_IN_MILLIS = 1000000;
var NANOS_IN_SECOND = 1000000000;
var MICROS_IN_SECOND = 1000000;
var MICROS_IN_MILLIS = 1000;
...
function hrTimeToTimeStamp(time) {
    ...
    var date = toISOString(new Date(time[0] * 1000));
    return date[_DYN_REPLACE ]("000Z", strRight(cNanoPadding.v + time[1] + "Z", NANOSECOND_DIGITS + 1));
}
/*#__NO_SIDE_EFFECTS__*/
...
function hrTimeToMicroseconds(time) {
    var microsFromSeconds = time[0] * MICROS_IN_SECOND;
    var microsFromNanos = Math.round(time[1] / MICROS_IN_MILLIS);
    return microsFromSeconds + microsFromNanos;
}
/*#__NO_SIDE_EFFECTS__*/
function isTimeInputHrTime(value) {
    return isArray(value) && value[_DYN_LENGTH ] === 2 && isNumber(value[0]) && isNumber(value[1]);
}
/*#__NO_SIDE_EFFECTS__*/
...
function createSpan(spanCtx, orgName, kind) {
    ...
    var spanStartTime = getDeferred(function () {
        if (isNullOrUndefined(spanCtx[_DYN_START_TIME ])) {
            return hrTime(perfStartTime);
        }
        return timeInputToHrTime(spanCtx[_DYN_START_TIME ]);
    });
    var spanEndTime;
    var spanDuration;
    var spanStatus;
    ...
    var theSpan = setProtoTypeName({
        ...
        setAttributes: function (attrs) {
            if (!_handleIsEnded() && isRecording && attributes) {
                ...
                localDroppedAttributes += (objKeys(attrs)[_DYN_LENGTH ] || 0);
            }
            return theSpan;
        },
    ...
    var provider = {
        ...
        createSpan: function (name, options, parent) {
            ...
            if (options && options.root) {
                ...
                newCtx = createDistributedTraceContext(parent || host[_DYN_GET_TRACE_CTX ]());
                if (newCtx.parentCtx) {
            ...
            var spanCtx = {
                ...
                startTime: options ? options[_DYN_START_TIME ] : undefined,
...
function useSpan(traceHost, span, fn, thisArg) {
    var scope = traceHost[_DYN_SET_ACTIVE_SPAN ](span);
    return _executeWithActiveSpan(scope, fn, thisArg, [scope][_DYN_CONCAT ](arrSlice(arguments, 4)));
}
...
function isReadableSpan(span) {
    return !!span &&
        ...
        "name" in span &&
        "kind" in span &&
        isFunction(span[_DYN_SPAN_CONTEXT ]) &&
        "duration" in span &&
        "ended" in span &&
        "startTime" in span &&
        "endTime" in span &&
...
function _getTraceCfg(context) {
    ...
    if (context) {
        ...
        else if (isFunction(context[_DYN_INITIALIZE ]) && context[_DYN_CONFIG ]) {
            traceCfg = context[_DYN_CONFIG ][_DYN_TRACE_CFG ];
        }
...
var MICROSOFT_APPLICATIONINSIGHTS_NAME = "Microsoft.ApplicationInsights.";
...
var AzureMonitorSampleRate = MICROSOFT_DOT + "sample_rate";
var ApplicationInsightsCustomEventName = MICROSOFT_DOT + "custom_event.name";
var MicrosoftClientIp = MICROSOFT_DOT + CLIENT_DOT$1 + "ip";
var ApplicationInsightsMessageName = MICROSOFT_APPLICATIONINSIGHTS_NAME + "Message";
var ApplicationInsightsExceptionName = MICROSOFT_APPLICATIONINSIGHTS_NAME + "Exception";
var ApplicationInsightsPageViewName = MICROSOFT_APPLICATIONINSIGHTS_NAME + "PageView";
var ApplicationInsightsAvailabilityName = MICROSOFT_APPLICATIONINSIGHTS_NAME + "Availability";
var ApplicationInsightsEventName = MICROSOFT_APPLICATIONINSIGHTS_NAME + "Event";
var ApplicationInsightsBaseType = "_MS.baseType";
var ApplicationInsightsMessageBaseType = "MessageData";
var ApplicationInsightsExceptionBaseType = "ExceptionData";
var ApplicationInsightsPageViewBaseType = "PageViewData";
var ApplicationInsightsAvailabilityBaseType = "AvailabilityData";
var ApplicationInsightsEventBaseType = "EventData";
...
var DBSYSTEMVALUES_COSMOSDB = "cosmosdb";
...
function createOTelApi(otelApiCtx) {
    ...
    var otelApi = setProtoTypeName(objDefineProps(_createTracerProvider(otelApiCtx[_DYN_HOST ]), {
        cfg: { g: function () { return otelApiCtx.host[_DYN_CONFIG ]; } },
...
var AttributeChangeOp = createEnumStyle({
    Clear: 0 ,
    Set: 1 ,
    Add: 2 ,
    Delete: 3
...
var _hasJsonStringify = ( /*#__PURE__*/safeGetLazy(function () { return !!getJSON()[_DYN_STRINGIFY ]; }, null));
...
function serializeAttribute(value) {
    ...
    else if ((!value[_DYN_TO_STRING ] || isObject(value)) && _hasJsonStringify.v) {
        result = safe(getJSON()[_DYN_STRINGIFY ], [value]).v;
    }
...
var otelInvalidAttributeErrorType;
function throwOTelInvalidAttributeError(message, attribName, value) {
    if (!otelInvalidAttributeErrorType) {
        otelInvalidAttributeErrorType = createCustomError("OTelInvalidAttributeError", function (self, args) {
            var len = args[_DYN_LENGTH ];
            self.attribName = len > 1 ? args[1] : STR_EMPTY;
            self[_DYN_VALUE ] = len > 2 ? args[2] : STR_EMPTY;
        }, getOpenTelemetryError());
    }
    throw new otelInvalidAttributeErrorType(message, attribName, value);
}

var otelSpanErrorType;
function throwOTelSpanError(message, spanName) {
    if (!otelSpanErrorType) {
        otelSpanErrorType = createCustomError("OTelSpanError", function (self, args) {
            var len = args[_DYN_LENGTH ];
...
function urlParseHost(url, inclPort) {
    var fullHost = urlParseFullHost(url, inclPort) || STR_EMPTY;
    if (fullHost) {
...
var RemoteDependencyData = /** @class */ (function () {
    function RemoteDependencyData(logger, id, absoluteUrl, commandName, value, success, resultCode, method, requestAPI, correlationContext, properties, measurements) {
        ...
        _self[_DYN_TYPE ] = dataSanitizeString(logger, requestAPI);
...
var ConfigurationManager = /** @class */ (function () {
    ...
    ConfigurationManager.getConfig = function (config, field, identifier, defaultValue) {
        if (defaultValue === void 0) { defaultValue = false; }
        var configValue;
        if (identifier && config[STR_EXTENSION_CONFIG ] && config[STR_EXTENSION_CONFIG ][identifier] && !isNullOrUndefined(config[STR_EXTENSION_CONFIG ][identifier][field])) {
            configValue = config[STR_EXTENSION_CONFIG ][identifier][field];
        }
        else {
...
function _populatePartC(item, container) {
    if (container) {
        ...
        _applyValue(partC_1, "netPeerName", container.get(SEMATTRS_NET_PEER_NAME$1), false);
        _applyValue(partC_1, "netPeerPort", container.get(SEMATTRS_NET_PEER_PORT$1), false);
        _applyValue(partC_1, "netPeerIp", container.get(SEMATTRS_NET_PEER_IP$1), false);
        _applyValue(partC_1, "peerService", container.get("service.name") || container.get(SEMATTRS_PEER_SERVICE$1), false);
...
exports.ATTR_CLIENT_ADDRESS = ATTR_CLIENT_ADDRESS$1;
exports.ATTR_CLIENT_PORT = ATTR_CLIENT_PORT$1;
exports.ATTR_ENDUSER_ID = ATTR_ENDUSER_ID;
exports.ATTR_ENDUSER_PSEUDO_ID = ATTR_ENDUSER_PSEUDO_ID;
exports.ATTR_ERROR_TYPE = ATTR_ERROR_TYPE;
exports.ATTR_EXCEPTION_MESSAGE = ATTR_EXCEPTION_MESSAGE;
exports.ATTR_EXCEPTION_STACKTRACE = ATTR_EXCEPTION_STACKTRACE;
exports.ATTR_EXCEPTION_TYPE = ATTR_EXCEPTION_TYPE;
exports.ATTR_HTTP_REQUEST_METHOD = ATTR_HTTP_REQUEST_METHOD$1;
exports.ATTR_HTTP_RESPONSE_STATUS_CODE = ATTR_HTTP_RESPONSE_STATUS_CODE$1;
exports.ATTR_HTTP_ROUTE = ATTR_HTTP_ROUTE;
exports.ATTR_NETWORK_LOCAL_ADDRESS = ATTR_NETWORK_LOCAL_ADDRESS;
exports.ATTR_NETWORK_LOCAL_PORT = ATTR_NETWORK_LOCAL_PORT;
exports.ATTR_NETWORK_PEER_ADDRESS = ATTR_NETWORK_PEER_ADDRESS$1;
exports.ATTR_NETWORK_PEER_PORT = ATTR_NETWORK_PEER_PORT;
exports.ATTR_NETWORK_PROTOCOL_NAME = ATTR_NETWORK_PROTOCOL_NAME;
exports.ATTR_NETWORK_PROTOCOL_VERSION = ATTR_NETWORK_PROTOCOL_VERSION;
exports.ATTR_NETWORK_TRANSPORT = ATTR_NETWORK_TRANSPORT;
exports.ATTR_SERVER_ADDRESS = ATTR_SERVER_ADDRESS$1;
exports.ATTR_SERVER_PORT = ATTR_SERVER_PORT$1;
exports.ATTR_URL_FULL = ATTR_URL_FULL$1;
exports.ATTR_URL_PATH = ATTR_URL_PATH$1;
exports.ATTR_URL_QUERY = ATTR_URL_QUERY$1;
exports.ATTR_URL_SCHEME = ATTR_URL_SCHEME$1;
exports.ATTR_USER_AGENT_ORIGINAL = ATTR_USER_AGENT_ORIGINAL$1;
...
exports.AppInsightsExtCore = AppInsightsExtCore;
exports.ApplicationInsightsAvailabilityBaseType = ApplicationInsightsAvailabilityBaseType;
exports.ApplicationInsightsAvailabilityName = ApplicationInsightsAvailabilityName;
exports.ApplicationInsightsBaseType = ApplicationInsightsBaseType;
exports.ApplicationInsightsCustomEventName = ApplicationInsightsCustomEventName;
exports.ApplicationInsightsEventBaseType = ApplicationInsightsEventBaseType;
exports.ApplicationInsightsEventName = ApplicationInsightsEventName;
exports.ApplicationInsightsExceptionBaseType = ApplicationInsightsExceptionBaseType;
exports.ApplicationInsightsExceptionName = ApplicationInsightsExceptionName;
exports.ApplicationInsightsMessageBaseType = ApplicationInsightsMessageBaseType;
exports.ApplicationInsightsMessageName = ApplicationInsightsMessageName;
exports.ApplicationInsightsPageViewBaseType = ApplicationInsightsPageViewBaseType;
exports.ApplicationInsightsPageViewName = ApplicationInsightsPageViewName;
exports.AttributeChangeOp = AttributeChangeOp;
exports.AzureMonitorSampleRate = AzureMonitorSampleRate;
...
exports.ChannelControllerPriority = ChannelControllerPriority;
...
exports.DBSYSTEMVALUES_COSMOSDB = DBSYSTEMVALUES_COSMOSDB;
exports.DBSYSTEMVALUES_DB2 = DBSYSTEMVALUES_DB2;
exports.DBSYSTEMVALUES_DERBY = DBSYSTEMVALUES_DERBY;
exports.DBSYSTEMVALUES_H2 = DBSYSTEMVALUES_H2;
exports.DBSYSTEMVALUES_HSQLDB = DBSYSTEMVALUES_HSQLDB;
exports.DBSYSTEMVALUES_MARIADB = DBSYSTEMVALUES_MARIADB;
exports.DBSYSTEMVALUES_MONGODB = DBSYSTEMVALUES_MONGODB;
exports.DBSYSTEMVALUES_MSSQL = DBSYSTEMVALUES_MSSQL;
exports.DBSYSTEMVALUES_MYSQL = DBSYSTEMVALUES_MYSQL;
exports.DBSYSTEMVALUES_ORACLE = DBSYSTEMVALUES_ORACLE;
exports.DBSYSTEMVALUES_OTHER_SQL = DBSYSTEMVALUES_OTHER_SQL;
exports.DBSYSTEMVALUES_POSTGRESQL = DBSYSTEMVALUES_POSTGRESQL;
exports.DBSYSTEMVALUES_REDIS = DBSYSTEMVALUES_REDIS;
exports.DBSYSTEMVALUES_SQLITE = DBSYSTEMVALUES_SQLITE;
exports.DEFAULT_BREEZE_ENDPOINT = DEFAULT_BREEZE_ENDPOINT;
exports.DEFAULT_BREEZE_PATH = DEFAULT_BREEZE_PATH;
exports.Data = Data;
exports.DataPoint = DataPoint;
exports.DependencyTypes = DependencyTypes;
...
exports.EXP_ATTR_ENDUSER_ID = EXP_ATTR_ENDUSER_ID;
exports.EXP_ATTR_ENDUSER_PSEUDO_ID = EXP_ATTR_ENDUSER_PSEUDO_ID;
exports.EXP_ATTR_SYNTHETIC_TYPE = EXP_ATTR_SYNTHETIC_TYPE;
...
exports.ExtFullVersionString = ExtFullVersionString;
exports.ExtVersion = ExtVersion;
exports.Extensions = Extensions;
exports.FullVersionString = FullVersionString;
exports.HttpMethod = HttpMethod;
exports.INVALID_SPAN_ID = INVALID_SPAN_ID;
exports.INVALID_TRACE_ID = INVALID_TRACE_ID;
...
exports.MicrosoftClientIp = MicrosoftClientIp;
...
exports.SEMATTRS_DB_OPERATION = SEMATTRS_DB_OPERATION;
exports.SEMATTRS_DB_STATEMENT = SEMATTRS_DB_STATEMENT;
exports.SEMATTRS_DB_SYSTEM = SEMATTRS_DB_SYSTEM;
exports.SEMATTRS_ENDUSER_ID = SEMATTRS_ENDUSER_ID;
exports.SEMATTRS_EXCEPTION_MESSAGE = SEMATTRS_EXCEPTION_MESSAGE;
exports.SEMATTRS_EXCEPTION_STACKTRACE = SEMATTRS_EXCEPTION_STACKTRACE;
exports.SEMATTRS_EXCEPTION_TYPE = SEMATTRS_EXCEPTION_TYPE;
exports.SEMATTRS_HTTP_CLIENT_IP = SEMATTRS_HTTP_CLIENT_IP$1;
exports.SEMATTRS_HTTP_FLAVOR = SEMATTRS_HTTP_FLAVOR;
exports.SEMATTRS_HTTP_HOST = SEMATTRS_HTTP_HOST$1;
exports.SEMATTRS_HTTP_METHOD = SEMATTRS_HTTP_METHOD$1;
exports.SEMATTRS_HTTP_ROUTE = SEMATTRS_HTTP_ROUTE;
exports.SEMATTRS_HTTP_SCHEME = SEMATTRS_HTTP_SCHEME$1;
exports.SEMATTRS_HTTP_STATUS_CODE = SEMATTRS_HTTP_STATUS_CODE$1;
exports.SEMATTRS_HTTP_TARGET = SEMATTRS_HTTP_TARGET$1;
exports.SEMATTRS_HTTP_URL = SEMATTRS_HTTP_URL$1;
exports.SEMATTRS_HTTP_USER_AGENT = SEMATTRS_HTTP_USER_AGENT$1;
exports.SEMATTRS_NET_HOST_IP = SEMATTRS_NET_HOST_IP;
exports.SEMATTRS_NET_HOST_NAME = SEMATTRS_NET_HOST_NAME;
exports.SEMATTRS_NET_HOST_PORT = SEMATTRS_NET_HOST_PORT;
exports.SEMATTRS_NET_PEER_IP = SEMATTRS_NET_PEER_IP$1;
exports.SEMATTRS_NET_PEER_NAME = SEMATTRS_NET_PEER_NAME$1;
exports.SEMATTRS_NET_PEER_PORT = SEMATTRS_NET_PEER_PORT$1;
exports.SEMATTRS_NET_TRANSPORT = SEMATTRS_NET_TRANSPORT;
exports.SEMATTRS_PEER_SERVICE = SEMATTRS_PEER_SERVICE$1;
exports.SEMATTRS_RPC_GRPC_STATUS_CODE = SEMATTRS_RPC_GRPC_STATUS_CODE;
exports.SEMATTRS_RPC_SYSTEM = SEMATTRS_RPC_SYSTEM;
...
exports.UrlRedactionOptions = UrlRedactionOptions;
...
exports.createAttributeContainer = createAttributeContainer;
exports.createAttributeSnapshot = createAttributeSnapshot;
...
exports.createNonRecordingSpan = createNonRecordingSpan;
exports.createOTelApi = createOTelApi;
exports.createOTelTraceState = createOTelTraceState;
...
exports.createTraceProvider = createTraceProvider;
...
exports.getOpenTelemetryError = getOpenTelemetryError;
exports.getPeerIp = getPeerIp;
exports.getPerformance = getPerformance;
exports.getResponseText = getResponseText;
exports.getSetValue = getSetValue;
exports.getSyntheticType = getSyntheticType;
exports.getTenantId = getTenantId;
exports.getTime = getTime;
exports.getUrl = getUrl;
exports.getUserAgent = getUserAgent;
exports.getWindow = getWindow;
exports.handleAttribError = handleAttribError;
exports.handleDebug = handleDebug;
exports.handleError = handleError;
exports.handleNotImplemented = handleNotImplemented;
...
exports.isAttributeContainer = isAttributeContainer;
...
exports.isDistributedTraceContext = isDistributedTraceContext;
...
exports.isOTelTraceState = isOTelTraceState;
exports.isObject = isObject;
exports.isReactNative = isReactNative;
exports.isReadableSpan = isReadableSpan;
...
exports.setObjStringTag = setObjStringTag;
exports.setProcessTelemetryTimings = setProcessTelemetryTimings;
exports.setProtoTypeName = setProtoTypeName;
...
exports.throwOTelError = throwOTelError;
exports.throwOTelInvalidAttributeError = throwOTelInvalidAttributeError;
exports.throwOTelSpanError = throwOTelSpanError;
...
exports.zeroHrTime = zeroHrTime;

}));
//# sourceMappingURL=applicationinsights-core-js.gbl.js.map
