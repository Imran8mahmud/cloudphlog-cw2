...
declare namespace ApplicationInsights {
     ...
     * @group Classes
     */
    class ApplicationInsights implements IApplicationInsights<IConfiguration & IConfig> {
        snippet: Snippet;
        /**
         ...
         */
        readonly pluginVersionString: string;
        readonly trace: ITraceApi;
        readonly otelApi: IOTelApi;
         ...
         */
        getTraceCtx(): IDistributedTraceContext | null;
        /**
         * Sets the current distributed trace context for this instance if available
         */
    ...
    class DependenciesPlugin extends BaseTelemetryPlugin implements IAjaxMonitorPlugin {
     ...
     */
    type DependencyListenerFunction = (dependencyDetails: IDependencyListenerDetails) => boolean | void;
     ...
     */
    interface IAjaxMonitorPlugin extends IPlugin, IDependenciesPlugin, IInstrumentationRequirements, IDependencyListenerContainer {
        /**
         * Resets the ajax attempts counter. This is typically called on page view to allow a fresh set of ajax calls to be tracked.
         */
        resetAjaxAttempts(): void;
    ...
    interface IApplicationInsights<CfgType extends IConfiguration = IConfiguration> extends IAppInsights, IDependenciesPlugin, IPropertiesPlugin, ITraceHost<CfgType> {
